...
if($ler->getContaLinhas() >= 3){
  header("Location: " . URL_CAMINHO_PAINEL_CLIENTE ."/index.php");
  exit();
}
...
if(isset($email) && $email != null){
    ...
    if($recuperar->getResultado()){
     ...
     Formata::EnviaEmail('Recuperação de senha do e-mail ' . $email, $mensagem, '/', EMAIL, 'Recuperando Senha');
      header("Location: " . URL_CAMINHO_PAINEL_CLIENTE ."/index.php?senhaModificada=true");     
    }else{
    ...
    header("Location: " . URL_CAMINHO_PAINEL_CLIENTE ."/index.php?emailNaoExiste=true");   
    }
}
