...
if($email == null){
  header("Location: " . URL_CAMINHO_PAINEL . "zion_esqueceu.php?email_nao_existe=true");
  exit();
}

if($horaAtual == null){
    header("Location: " . URL_CAMINHO_PAINEL . "zion_esqueceu.php?tempo_invalido=true");
    exit();
  }
...
$zion = new Ler();
$zion->Leitura('usuarios', "WHERE email = :email AND codigo = :codigo AND hora = :hora", "email={$email}&codigo={$cod}&hora={$horaAtual}");
$checaEmail = Formata::Resultado($zion);
if(!$checaEmail){
header("Location: " . URL_CAMINHO_PAINEL . "zion_esqueceu.php?email_nao_existe=true");
exit();
}else{
...
$ip = $_SERVER['REMOTE_ADDR'];
$zion = new Ler();
$zion->Leitura('login_tetativas', "WHERE ip = :ip", "ip={$ip}");
?>


<body>
<?php if ($zion->getContaLinhas() >= 3) { ?>
          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              <div class="card-header">
                <center>
                  <img src="<?= ZION_LOGO ?>" alt="<?= ZION_TITULO_PAINEL ?>" class="img-fluid">
                </center>
              ...
              <div class="card-body">
                <form method="post" action="zion-filtros/nova_senha.php" class="needs-validation" novalidate="">
                ...
                <?php require_once('zion_rodape_login.php'); ?>
                <!-- auth-login.html  15 Out 2024 03:49:32 GMT -->