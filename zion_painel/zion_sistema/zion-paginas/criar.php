 ...
 <div class="main-content">
   ...
   <section class="section">
     ...
     <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-paginas/filtros/criar&token=<?= $_SESSION['timeWT'] ?>" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group row mb-4">
                   ...
                   <div class="custom-switches-stacked mt-2">
                     <label class="custom-switch">
                       <input type="radio" name="sem_imagem" value="S" class="custom-switch-input">
                       <span class="custom-switch-indicator"></span>
                       <span class="custom-switch-description">Sim</span>
                     </label>
                     <label class="custom-switch">
                       <input type="radio" name="sem_imagem" value="N" class="custom-switch-input">
                       <span class="custom-switch-indicator"></span>
