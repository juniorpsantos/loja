...
<div class="main-content">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-categorias/index&token=<?= $_SESSION['timeWT'] ?>">Atualizar</a></li>
    ...
    ?>
        ...
        <section class="section">
            ...
            <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-categorias/filtros/criar&token=<?= $_SESSION['timeWT'] ?>" method="post">
    ...
    ?>
        ...
        <section class="section">
            <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-categorias/filtros/atualizar&token=<?= $_SESSION['timeWT'] ?>" method="post">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?= URL_CAMINHO_PAINEL . FILTROS . "zion-categorias/index&editar={$categoria->id}&token={$_SESSION['timeWT']}" ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
                                                    <td>
                                                        <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-categorias/filtros/excluir&token=<?= $_SESSION['timeWT'] ?>" method="post">
