<div class="main-content">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-blog/criar&token=<?= $_SESSION['timeWT'] ?> ">Novo</a></li>
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <td><a href="<?= URL_CAMINHO_PAINEL . FILTROS . 'zion-blog/atualizar&editar=' . $post->id . '&token=' . $_SESSION['timeWT'] ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
                          <td>
                            <form action="<?= URL_CAMINHO_PAINEL . FILTROS . 'zion-blog/filtros/excluir&token=' . $_SESSION['timeWT'] ?>" method="post">
