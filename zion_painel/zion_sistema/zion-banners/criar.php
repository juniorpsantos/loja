 ...
 <div class="main-content">
   ...
   <section class="section">
     ...
     <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-banners/filtros/criar&token=<?= $_SESSION['timeWT'] ?>" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group row mb-4">
                   ...
                   <div class="col-md-7">
                     <select name="local" class="form-control">
                       <option value="BannerMenu200x350">Banner Menu - 200x350px</option>
                       <option value="BannerMenu200x350-2">Banner Menu 2 - 200x350px</option>
                       <option value="BannerSlide370x120">Banner Slide - 370x120px</option>
                       <option value="Pop-up">Pop-up - 700x400px</option>
                       <option value="BannerInicioOfertas574x420">Banner Inicio Ofertas - 574x420px</option>
                       <option value="BannerInicioAbas218x390">Banner Inicio Abas - 218x390px</option>
                       <option value="BannerInicioMarcas100x72">Banner Marcas - 100x72px</option>
                       <option value="BannerCategoria280x280">Banner Categoria - 280x280px</option>
                       <option value="BannerPagina280x280">Banner Pagina - 280x280px</option>
                     </select>
                   </div>
                 </div>
