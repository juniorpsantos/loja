<div class="main-content">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-slide/criar&token=<?= $_SESSION['timeWT'] ?> ">Novo</a></li>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                  ...
                  <tbody>
                    ...
                    $zion->Leitura('banners', "WHERE tipo = 'slide' ORDER BY data DESC");
                    ...
                    ?>
                        <tr>
                          ...
                          <td><?= $banner->titulo ?></td>
                          <td><a href="<?= URL_CAMINHO_PAINEL . FILTROS . 'zion-slide/atualizar&editar=' . $banner->id . '&token=' . $_SESSION['timeWT'] ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
                          <td>
                            <form action="<?= URL_CAMINHO_PAINEL . FILTROS . 'zion-slide/filtros/excluir&token=' . $_SESSION['timeWT'] ?>" method="post">
