        ...
        <div class="section-body">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Visitas por Sub-Categoria</h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Visitas em Sub-Categorias</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $zion->Leitura('categorias', "WHERE tipo = 'filho' ORDER BY visitas DESC");
    ...
    const meuGrafico = new Chart(ctx, {
        ...
        data: {
            ...
            labels: [
                <?php
                $ler = new Ler();
                $ler->Leitura('categorias', "WHERE tipo = 'filho' ORDER BY nome ASC");
                if ($categoriasRelatorio) {
