                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        $zion->Leitura('categorias', "WHERE tipo = 'pai' ORDER BY visitas DESC");
    ...
    const meuGrafico = new Chart(ctx, {
        ...
        data: {
            ...
            labels: [
                <?php
                $ler = new Ler();
                $ler->Leitura('categorias', "WHERE tipo = 'pai' ORDER BY nome ASC");
                if ($categoriasRelatorio) {
