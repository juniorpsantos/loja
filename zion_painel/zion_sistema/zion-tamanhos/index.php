    ...
    <div class="main-content">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-tamanhos/index&token=<?= $_SESSION['timeWT'] ?>">Atualizar</a></li>
        ...
        ?>
            ...
            <section class="section">
                ...
                <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-tamanhos/filtros/criar&token=<?= $_SESSION['timeWT'] ?>" method="post">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="nome" placeholder="Adicione o tamanho" required="">
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <input type="hidden" name="tipo" value="tamanho">
        ...
        ?>
            ...
            <section class="section">
                <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-tamanhos/filtros/atualizar&token=<?= $_SESSION['timeWT'] ?>" method="post">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="nome" placeholder="Adicione o tamanho" value="<?= $upAdicional->nome ? $upAdicional->nome : null; ?>" style="border:1px solid red;">
                                            </div>
                                            <div class="col-md-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $zion->Leitura('adicionais', "WHERE tipo = 'tamanho' ORDER BY data DESC");
                                            ...
                                            ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= $adicional->nome ? $adicional->nome : null; ?>
                                                        </td>

                                                        <td><?= $adicional->estoque; ?></td>
                                                        <td><?= $produto->titulo ?></td>
                                                        <td><a href="<?= URL_CAMINHO_PAINEL . FILTROS . "zion-tamanhos/index&editar={$adicional->id}&token={$_SESSION['timeWT']}" ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
                                                        <td>
                                                            <form action="<?= URL_CAMINHO_PAINEL . FILTROS ?>zion-tamanhos/filtros/excluir&token=<?= $_SESSION['timeWT'] ?>" method="post">
