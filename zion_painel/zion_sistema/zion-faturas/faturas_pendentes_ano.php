<div class="main-content">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Faturas Pendentes do Ano</li>
        </ol>
    </nav>
    <!-- FIM NAVEGAÇÃO --->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h4>Faturas Pendentes do Ano de <?= $ano ?></h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $zion->Leitura('faturas', "WHERE status != 'paid' AND ano = :ano ORDER BY data DESC", "ano={$ano}");
