                    ...
                    <form action="<?= HOME ?>/ms/finalCompraCadastro" method="post">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <label>CEP *</label>
                                <input type="text" id="cepmj" class="form-control" name="cep" placeholder="CEP">
                                    ...
                                    <table class="table table-summary">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="summary-total">
                                                <td style="color:#333!important;">Total:</td>
                                                <td style="color:#333!important;">R$ <?= Formata::vr($valorCarrinho) ?></td>
                                                <?php
                                                $_SESSION['total_digital'] = $valorCarrinho;
                                                $_SESSION['sessao_digital'] = $idSessao;
                                                ?>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label>Estado *</label>
                                        <select name="estado" id="" class="form-control select2 load_estados_ext" disabled>
                                            <?php
                                            $zion->Leitura('app_estados', "ORDER BY estado_nome ASC");
                                            $estadosCadastro = Formata::Resultado($zion);
                                            if ($estadosCadastro):
                                    ...
                                    <div class="col-sm-6">
                                        <label>Cidade *</label>
                                        <select name="cidade" id="load_cidades_ext" class="form-control" disabled>
                                ...
                                <input type="text" id="cepmj" class="form-control" name="cep" value="<?= $cliente->cep ? $cliente->cep : null; ?>">
