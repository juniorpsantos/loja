    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-3">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= HOME ?>/blog/">Blog</a></li>
                ...
                <div class="col-lg-9">
                    <article class="entry single-entry">
                        <figure class="entry-media">
                            ...
                            <?php else: ?>
                                <img src="<?= HOME ?>/sem-imagem777.jpg" alt="<?= $titulo ?>">
                            <?php endif; ?>
                    ...
                    <div class="related-posts">
                        <h3 class="title">Notícias Relacionadas</h3><!-- End .title -->
                        <div class="owl-carousel owl-simple" data-toggle="owl"
                            ...
                            <?php
                            $zion->Leitura('posts', "WHERE id != :id AND tipo = 'blog' ORDER BY data DESC", "id={$id}");
                            $noticiasRelacionadas = Formata::Resultado($zion);
                            ...
                            ?>
                                    <article class="entry entry-grid">
                                        ...
                                        <div class="entry-body">
                                            <div class="entry-meta">
                                                <a href="<?= HOME ?>/noticia/<?= $post->id ?>/<?= $post->url ?>" title=""><?= $post->dia ?> de <?= Formata::Mes($post->mes) ?> de <?= $post->ano ?></a>
                                            </div><!-- End .entry-meta -->
                                            <h2 class="entry-title">
                                                <a href="<?= HOME ?>/noticia/<?= $post->id ?>/<?= $post->url ?>" title=""><?= Formata::LimitaTextos($post->titulo, 2) ?></a>
                                            </h2><!-- End .entry-title -->
                    ...
                    <div class="sidebar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="posts-list">
                                ...
                                $produtoPosts->Leitura('produto', "WHERE destaque = 'S' AND tipo = 'produto' ORDER BY data DESC LIMIT 3");
                        ...
                        <div class="widget">
                            ...
                            <ul class="posts-list">
                                <?php
                                $outrosPosts = new Ler();
                                $outrosPosts->Leitura('posts', "WHERE id != :id AND tipo = 'blog' ORDER BY data DESC LIMIT 3", "id={$id}");
                        ...
                        <div class="widget widget-banner-sidebar">
                            <div class="banner-sidebar-title">Publicidades</div><!-- End .ad-title -->
                            <?php
                            $produtoPosts->Leitura('banners', "WHERE local = 'BannerPagina280x280' AND tipo = 'banner' LIMIT 2 OFFSET 1");
                            $bannerPosts = Formata::Resultado($produtoPosts);
                            if ($bannerPosts):
                                foreach ($produtoPosts->getResultado() as $banner):
                                    $banner = (object) $banner;
