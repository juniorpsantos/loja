                ...
                <div class="col-lg-9">
                    ...
                    <div class="products mb-3">
                        <div class="row justify-content-center">
                            ...
                            $pagina = new Paginacao(HOME . '/sub-categorias/' . $id . '/&pagina=');
                            $pagina->LerPaginas($lerUrl, 10);

                            $zion->Leitura('produto', "WHERE id_sub_categoria = :id {$valorSelecionado} LIMIT :limit OFFSET :offset", "id={$id}&limit={$pagina->getLimit()}&offset={$pagina->getOffset()}");
                            ...
                            <?php
                                endforeach;
                                $pagina->ListarPaginas('produto', "WHERE id_sub_categoria = :id {$valorSelecionado}", "id={$id}");
                            endif;
                            ?>
                        </div><!-- End .row -->
                    </div><!-- End .products -->
