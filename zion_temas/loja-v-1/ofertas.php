                ...
                <div class="col-lg-9">
                    ...
                    <div class="products mb-3">
                        <div class="row justify-content-center">
                            ...
                            $pagina = new Paginacao(HOME . '/ofertas/&pagina=');
                            $pagina->LerPaginas($lerUrl, 10);
                            $dataOferta = date('Y-m-d H:i:s');
                            $zion->Leitura('produto', "WHERE oferta >= :oferta {$valorSelecionado} LIMIT :limit OFFSET :offset", "oferta={$dataOferta}&limit={$pagina->getLimit()}&offset={$pagina->getOffset()}");
                            ...
                            <?php
                                endforeach;
                                $pagina->ListarPaginas('produto', "WHERE oferta >= :oferta {$valorSelecionado}", "oferta={$dataOferta}");
                            endif;
                            ?>
                        </div><!-- End .row -->
                    </div><!-- End .products -->
