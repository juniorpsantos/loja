...
/**
 * Gerente de paginação - Zion PHP
 * Classe para paginação de resultados
 * @copyright (c) 2024, Junior Santos - ZION TECH DIGITAL
 * Site oficial www.ziontechdigital.com.br
 */
class Paginacao {
    /** DEFINE O PAGER - JUNIOR SANTOS ZION TECH DIGITAL */
    private $Page;
    private $Limit;
    private $Offset;
    
    /** REALIZAR A LEITURA - JUNIOR SANTOS ZION TECH DIGITAL */
    private $Tabela;
    private $Termos;
    private $Places;
        
    /** DEFINE O PAGINATOR - JUNIOR SANTOS ZION TECH DIGITAL */
    private $Rows;
    private $Link;
    private $MaxLinks;
    private $First;
    ...
    /** RENDERIZA O PAGINATOR - JUNIOR SANTOS ZION TECH DIGITAL */
    private $Paginator;
